...
public class deliveredToRvAdapter extends RecyclerView.Adapter<deliveredToRvAdapter.userViewHolder> {

    ArrayList<UserObject> userArrayList = new ArrayList<>();
    Context mContext;
    public deliveredToRvAdapter(Context context, ArrayList<UserObject> userObjectArrayList) {
    ...
    @Override
    public deliveredToRvAdapter.userViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.user_listitem, viewGroup, false);

        return new deliveredToRvAdapter.userViewHolder(itemView);
    }
